        ...
        <?php if (!empty($vendedoresPagina)): ?>
          <?php foreach ($vendedoresPagina as $index => $seller): ?>
            <tr>
              ...
              <td><a href="<?= BASE_URL ?>vendedores/<?= $seller->id ?>" class="icon-link icon-link-hover fw-bolder text-capitalize"><svg
                    xmlns="http://www.w3.org/2000/svg" class="bi" viewBox="0 0 16 16" aria-hidden="true">
                    <path
